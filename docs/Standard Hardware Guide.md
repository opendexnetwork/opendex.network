...
/home/opendex/swapfile file  2G   0B   -2
```
Light setup - **DONE!** Continue [here](/docs/Liquidity%20Provider%20Guide.md#the-setup).
...
/media/SSD/swapfile file  8G   0B   -2
```
Full setup - **DONE!** Continue [here](/docs/Liquidity%20Provider%20Guide.md#the-setup).
